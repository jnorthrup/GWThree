...
import static com.akjava.gwt.three.client.THREE.Blending.NormalBlending;
...
//www.airtightinteractive.com/demos/cubes_three/
	...
	public void start(final WebGLRenderer renderer,final int width,final int height,FocusPanel panel) {
        ...
        Material material= THREE.ParticleBasicMaterial().color(0x888888).size(15).map(ImageUtils.loadTexture("img/particle7.png")).blending(NormalBlending.ordinal()).transparent(true).build();
