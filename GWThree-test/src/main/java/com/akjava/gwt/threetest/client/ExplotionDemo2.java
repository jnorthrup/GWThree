...
import static com.akjava.gwt.three.client.THREE.Blending.AdditiveBlending;
...
//www.airtightinteractive.com/demos/cubes_three/
	...
	public void start(final WebGLRenderer renderer,final int width,final int height,FocusPanel panel) {
        ...
        Material material= THREE.ParticleBasicMaterial().color(0xff0000).size(2).map(ImageUtils.loadTexture("img/particle.png")).blending(AdditiveBlending.ordinal()).transparent(true).build();
